...
def encrypt():
    ...
    return render_template('index.html', encrypted_message=encrypted_message.hex(), encryption_time=encryption_time, algorithm=algorithm)
...
def decrypt():
    ...
    return render_template('index.html', decrypted_message=decrypted_message.decode(), decryption_time=decryption_time, algorithm=algorithm)
